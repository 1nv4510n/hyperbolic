...
window.onload = function () {
    ...
    // Градиент для (hyperboliccylinder(), parabolyccylinder(), cilindr(), conus(), sphera, singlehyperboloid(), ellipticparaboloid() - с багами, (doublehyperboloid(), bublik() - не факт что правильно))
   /* function gradient() {
        let k = 0
    ...
    //(1x1 для parabolyccylinder(), bublik()) (зебра для cilindr(), ellipticparaboloid(), doublehyperboloid(), singlehyperboloid())
    /*let t = 4;
    let ab = 0;
    let cb = 0;
    let clr1 = {r:0, g:0, b:0};
